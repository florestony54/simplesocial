...
urlpatterns = [
    ...
    re_path(r'^post/(?P<username>[-\w]+)/comment/$', views.add_comment_to_post, name='add_comment_to_post'),
    re_path(r'^comment/(?P<username>[-\w]+)/comment/$', views.add_comment_to_post, name='add_comment_to_post'),
